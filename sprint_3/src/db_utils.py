...
connection_handler = logging.FileHandler(r'C:\Users\GuledM(DE-LON16)\Documents\Group-Project\brews_brothers_DELON16\sprint_2\notes\db_connection.log') #where to store the log which is a file called db_connection.log
...
def db_connection():
    ...
    try: #tries to connect and if it fails it returns an error message which is logged. 
        ...
        connection_logger.info("Date set to DD/MM/YYYY")
        return conn,cursor
